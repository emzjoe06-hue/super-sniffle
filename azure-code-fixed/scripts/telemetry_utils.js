...
const USER_AZURE_DIR = path.join(homedir(), AZURE_DIR);
// Project-level .gemini directory in the workspace
const WORKSPACE_AZURE_DIR = path.join(projectRoot, AZURE_DIR);

// Telemetry artifacts are stored in a hashed directory under the user's ~/.gemini/tmp
export const OTEL_DIR = path.join(USER_AZURE_DIR, 'tmp', projectHash, 'otel');
