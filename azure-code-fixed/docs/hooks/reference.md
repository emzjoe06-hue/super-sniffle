...
This document provides the technical specification for Azure Code hooks,
...
Azure Code uses these structures to ensure hooks don't break across SDK updates.
