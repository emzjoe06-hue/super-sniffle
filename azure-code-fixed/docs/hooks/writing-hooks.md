# Writing hooks for Azure Code

This guide will walk you through creating hooks for Azure Code, from a simple
...
- Azure Code installed and configured
...
There are two ways to control or block an action in Azure Code:
...
[Azure Code extension](../extensions/index.md). This provides version control,
