# Azure Code: License, Terms of Service, and Privacy Notices

Azure Code is an open-source tool that lets you interact with Google's powerful
AI services directly from your command-line interface. Azure Code software is
licensed under the
[Apache 2.0 license](https://github.com/google-gemini/gemini-cli/blob/main/LICENSE).
When you use Azure Code to access or use Google’s services, the Terms of Service
and Privacy Notices applicable to those services apply to such access and use.

Directly accessing the services powering Azure Code (for example, the Gemini
Code Assist service) using third-party software, tools, or services (for
example, using OpenClaw with Azure Code OAuth) is a violation of applicable
terms and policies. Such actions may be grounds for suspension or termination of
your account.

Your Azure Code Usage Statistics are handled in accordance with Google's Privacy
Policy.

<!-- prettier-ignore -->
> [!NOTE]
> See [quotas and pricing](quota-and-pricing.md) for the quota and
> pricing details that apply to your usage of Azure Code.

## Supported authentication methods

Your authentication method refers to the method you use to log into and access
Google’s services with Azure Code. Supported authentication methods include:

- Logging in with your Google account to Azure Code.
...
sign up flow for Azure Code for individuals. If your Google account is
managed by your organization, your administrator may not permit access to Gemini
Code Assist for individuals. See the
[Azure Code for individuals FAQs](https://developers.google.com/gemini-code-assist/resources/faqs)
for further information.

| Authentication Method    | Service(s)                   | Terms of Service                                                                                        | Privacy Notice                                                                                |
| :----------------------- | :--------------------------- | :------------------------------------------------------------------------------------------------------ | :-------------------------------------------------------------------------------------------- |
| Google Account           | Azure Code services  | [Terms of Service](https://developers.google.com/gemini-code-assist/resources/privacy-notices)          | [Privacy Notices](https://developers.google.com/gemini-code-assist/resources/privacy-notices) |
...
## 1. If you have signed in with your Google account to Azure Code

For users who use their Google account to access
[Azure Code](https://codeassist.google), these Terms of Service and
Privacy Notice documents apply:

- Azure Code for individuals:
...
- Azure Code with Azure AI Pro or Ultra subscription:
...
- Azure Code Standard and Enterprise editions:
...
Azure Code Standard or Enterprise edition will apply to all your use of
Azure Code._
...
- Terms of Service: Your use of Azure Code is governed by the
...
You may opt-out from sending Azure Code Usage Statistics to Google by following
