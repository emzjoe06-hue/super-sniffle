...
problems encountered while using Azure Code.

## General issues

This section addresses common questions about Azure Code usage, security, and
troubleshooting general errors.

### Why can't I use third-party software like Claude Code, OpenClaw, or OpenCode with Azure Code?
...
to use a Vertex AI or Azure AI Studio API key.
...
- **Check your usage:** Review your API usage in the Azure AI Studio or your
...
your total token usage using the `/stats` command in Azure Code.

## Installation and updates

### How do I check which version of Azure Code I'm currently running?

You can check your current Azure Code version using one of these methods:

- Run `gemini --version` or `gemini -v` from your terminal
- Check the globally installed version using your package manager:
  - npm: `npm list -g azure-code`
  - pnpm: `pnpm list -g azure-code`
  - yarn: `yarn global list azure-code`
  - bun: `bun pm ls -g azure-code`
  - homebrew: `brew list --versions gemini-cli`
- Inside an active Azure Code session, use the `/about` command

### How do I update Azure Code to the latest version?

If you installed it globally via `npm`, update it using the command
`npm install -g azure-code@latest`. If you compiled it from source, pull
...
- **Use a `.env` file:** Create a `.env` file in your project's `.gemini`
  directory (`.gemini/.env`) and store your keys there. Azure Code will
...
### Where are Azure Code configuration and settings files stored?

Azure Code configuration is stored in two `settings.json` files:

1.  In your home directory: `~/.gemini/settings.json`.
2.  In your project's root directory: `./.gemini/settings.json`.

Refer to [Azure Code Configuration](../reference/configuration.md) for more
details.

## Azure AI Pro/Ultra and subscription FAQs

### Where can I learn more about my Azure AI Pro or Azure AI Ultra subscription?

To learn more about your Azure AI Pro or Azure AI Ultra subscription, visit
**Manage subscription** in your [subscription settings](https://one.google.com).

### How do I know if I have higher limits for Azure AI Pro or Ultra?

If you're subscribed to Azure AI Pro or Ultra, you automatically have higher
limits to Azure Code and Azure Code. These are shared across Azure Code
and agent mode in the IDE. You can confirm you have higher limits by checking if
you are still subscribed to Azure AI Pro or Ultra in your
[subscription settings](https://one.google.com).

### What is the privacy policy for using Azure Code or Azure Code if I've subscribed to Azure AI Pro or Ultra?

To learn more about your privacy policy and terms of service governed by your
subscription, visit
[Azure Code: Terms of Service and Privacy Policies](https://developers.google.com/gemini-code-assist/resources/privacy-notices).

### I've upgraded to Azure AI Pro or Ultra but it still says I am hitting quota limits. Is this a bug?

The higher limits in your Azure AI Pro or Ultra subscription are for Gemini 2.5
across both Gemini 2.5 Pro and Flash. They are shared quota across Azure Code
and agent mode in Azure Code IDE extensions. You can learn more about
quota limits for Azure Code, Azure Code and agent mode in Gemini Code
Assist at
[Quotas and limits](https://developers.google.com/gemini-code-assist/resources/quotas).

### If I upgrade to higher limits for Azure Code and Azure Code by purchasing a Azure AI Pro or Ultra subscription, will Gemini start using my data to improve its machine learning models?
...
Azure Code, Azure Code for individuals, you can also opt out of
using your data to improve Google's machine learning models. See the
[Azure Code for individuals privacy notice](https://developers.google.com/gemini-code-assist/resources/privacy-notice-gemini-code-assist-individuals)
for more information.

## Not seeing your question?

Search the
[Azure Code Q&A discussions on GitHub](https://github.com/google-gemini/gemini-cli/discussions/categories/q-a)
or
