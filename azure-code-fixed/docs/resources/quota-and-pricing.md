# Azure Code: Quotas and pricing

Azure Code offers a generous free tier that covers many individual developers'
...
This article outlines the specific quotas and pricing applicable to Azure Code
...
| :-------------------- | :------------------------------ | :-------------------------------- |
| **Google account**    | Azure Code (Individual) | 1,000 requests                    |
|                       | Azure AI Pro                   | 1,500 requests                    |
|                       | Azure AI Ultra                 | 2,000 requests                    |
...
Access to Azure Code begins with a generous free tier, perfect for
experimentation and light use.

Your free usage is governed by the following limits, which depend on your
authorization type.

### Log in with Google (Azure Code for individuals)
...
Learn more at
[Azure Code for Individuals Limits](https://developers.google.com/gemini-code-assist/resources/quotas#quotas-for-agent-mode-gemini-cli).
...
Azure Code by upgrading to one of the following subscriptions:
...
**Supported tiers:** _- Tiers not listed above, including Azure AI Plus, are
not supported._

- [Azure AI Pro and AI Ultra](https://gemini.google/subscriptions/). This is
  ...
  Learn more at
  [Azure Code Quotas and Limits](https://developers.google.com/gemini-code-assist/resources/quotas)
...
- [Purchase a Azure Code Subscription through Google Cloud](https://cloud.google.com/gemini/docs/codeassist/overview).
  ...
  - Azure Code Standard edition:
    - 1500 maximum model requests / user / day
  - Azure Code Enterprise edition:
    - 2000 maximum model requests / user / day
  - Model requests will be made across the Gemini model family as determined by
    Azure Code.

  [Learn more about Azure Code license limits](https://developers.google.com/gemini-code-assist/resources/quotas#quotas-for-agent-mode-gemini-cli).
...
Azure Code. Supporting these plans is under active consideration for future
support.
