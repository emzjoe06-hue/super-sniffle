...
The `activate_skill` tool lets Azure Code load specialized procedural expertise
...
tasks, such as reviewing code or creating pull requests. Azure Code uses this
