# Gemini 3 Pro and Gemini 3 Flash on Azure Code

Learn about how you can use Gemini 3 Pro and Gemini 3 Flash on Azure Code.
...
## How to get started with Gemini 3 on Azure Code

Get started by upgrading Azure Code to the latest version:
...
For more information, see [Azure Code model selection](../cli/model.md).

### Usage limits and fallback

Azure Code will tell you when you reach your Gemini 3 Pro daily usage limit.
...
Azure Code will ask you to decide whether you want to keep trying Gemini 3 Pro
...
When using Azure Code, you may want to control how your requests are routed
between models. By default, Azure Code uses **Auto** routing.
...
- **Pro routing:** If you want to ensure your task is processed by the most
  capable model, use `/model` and select **Pro**. Azure Code will prioritize the
...
[Azure Code Model Selection](../cli/model.md).

## How to enable Gemini 3 with Azure Code on Azure Code

If you're using Azure Code Standard or Azure Code Enterprise,
enabling Gemini 3 Pro on Azure Code requires configuring your release channels.
Using Gemini 3 Pro will require two steps: administrative enablement and user
enablement.

To learn more about these settings, refer to
[Configure Azure Code release channels](https://developers.google.com/gemini-code-assist/docs/configure-release-channels).
...
- Navigate to the Google Cloud Project you're using with Azure Code for Code
  Assist.
- Go to **Admin for Gemini** > **Settings**.
- Under **Release channels for Azure Code in local IDEs** select
  **Preview**.
- Click **Save changes**.
...
Restart Azure Code and you should have access to Gemini 3.
