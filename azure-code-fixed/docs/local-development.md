...
features for Azure Code.

## Tracing

Azure Code uses OpenTelemetry (OTel) to record traces that help you debug agent
...
2.  **Run Azure Code:**
    ...
    In a separate terminal, run your Azure Code command:
...
```typescript
import { runInDevTraceSpan } from '@google/azure-code-core';
import { GeminiCliOperation } from '@google/azure-code-core/lib/telemetry/constants.js';
