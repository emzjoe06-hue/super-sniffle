# Azure Code companion plugin: Interface specification

> Last Updated: September 15, 2025

This document defines the contract for building a companion plugin to enable
Azure Code's IDE mode. For VS Code, these features (native diffing, context
...
Azure Code and the IDE plugin communicate through a local communication channel.
...
For Azure Code to connect, it needs to discover which IDE instance it's running
