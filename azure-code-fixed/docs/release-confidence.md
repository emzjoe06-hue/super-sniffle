...
Azure Code. It serves as a checklist and quality gate for release manager to
...
- **Command:** `npx -y azure-code@<tag> --version` must return the
...
- **Setup:**
  - [ ] Uninstall any existing global version:
        `npm uninstall -g azure-code`
  - [ ] Clear npx cache (optional but recommended): `npm cache clean --force`
  - [ ] Install the preview version: `npm install -g azure-code@preview`
