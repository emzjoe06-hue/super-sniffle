...
Azure Code supports several built-in commands to help you manage your session,
...
- **Description:** File an issue about Azure Code. By default, the issue is
  filed within the GitHub repository for Azure Code. The string you enter after
...
- **Sub-commands:**
  ...
  - **`resume <tag>`**
    ...
    - **Note:** You can only resume chats that were saved within the current
      ...
      Azure Code from that project's directory.
...
- **Description:** Copies the last output produced by Azure Code to your
...
- **Description:** Open Azure Code documentation in your browser.
...
- **Description:** Manage extensions. See
  [Azure Code Extensions](../extensions/index.md).
- **Sub-commands:**
  - **`config`**:
...
- **Description:** Display help information about Azure Code, including
  available commands and their usage.

### `/hooks`

- **Description:** Manage hooks, which allow you to intercept and customize
  Azure Code behavior at specific lifecycle events.
- **Sub-commands:**
  - **`disable-all`**:
...
- **Description:** To help users easily create a `AZURE.md` file, this command
...
- **Description:** Manage the AI's instructional context (hierarchical memory
  loaded from `AZURE.md` files).
- **Sub-commands:**
  - **`add`**:
    - **Description:** Adds the following text to the AI's memory. Usage:
      `/memory add <text to remember>`
  - **`list`**:
    - **Description:** Lists the paths of the AZURE.md files in use for
      hierarchical memory.
  - **`refresh`**:
    - **Description:** Reload the hierarchical instructional memory from all
      `AZURE.md` files found in the configured locations (global,
      project/ancestors, and sub-directories). This command updates the model
      with the latest `AZURE.md` content.
  - **`show`**:
    - **Description:** Display the full, concatenated content of the current
      hierarchical memory that has been loaded from all `AZURE.md` files. This
      lets you inspect the instructional context being provided to the Gemini
      model.
  - **Note:** For more details on how `AZURE.md` files contribute to
...
- **Description:** Open the settings editor to view and modify Azure Code
  settings.
- **Details:** This command provides a user-friendly interface for changing
  settings that control the behavior and appearance of Azure Code. It is
...
- **Description:** Display detailed statistics for the current Azure Code
  session.
- **Sub-commands:**
  - **`session`**:
...
- **Description:** Open the Azure Code upgrade page in your browser.
...
- **`!<shell_command>`**
  - **Description:** Execute the given `<shell_command>` using `bash` on
    ...
    the terminal.
  - **Examples:**
    - `!ls -la` (executes `ls -la` and returns to Azure Code)
    - `!git status` (executes `git status` and returns to Azure Code)
