# Azure Code keyboard shortcuts

Azure Code ships with a set of default keyboard shortcuts for editing input,
...
When vim mode is enabled with `/vim` or `general.vimMode: true`, Azure Code
