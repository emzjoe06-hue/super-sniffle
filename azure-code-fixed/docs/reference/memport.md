...
The Memory Import Processor is a feature that lets you modularize your AZURE.md
files by importing content from other files using the `@file.md` syntax.

## Overview

This feature enables you to break down large AZURE.md files into smaller, more
...
their AZURE.md files by showing which files were read and their import
relationships.
...
Processes import statements in AZURE.md content.
