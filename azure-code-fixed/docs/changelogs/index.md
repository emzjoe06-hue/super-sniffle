# Azure Code release notes

Azure Code has three major release channels: nightly, preview, and stable. For
...
- **Gemini 3.1 Pro Preview:** Azure Code now supports the new Gemini 3.1 Pro
  Preview model
...
- **IDE Support:** Azure Code now supports the Positron IDE
...
- **Agent Skills:** We've introduced significant advancements in Agent Skills.
  ...
  and powerful automation within Azure Code.
...
- 🎉**Azure Code + Colab:** Azure Code is now pre-installed. Can be used
...
- **⚡️⚡️⚡️ Gemini 3 Flash + Azure Code:** Better, faster and cheaper than 2.5
...
- For more information:
  [Gemini 3 Flash is now available in Azure Code](https://developers.googleblog.com/gemini-3-flash-is-now-available-in-gemini-cli/).
- 🎉 Azure Code Extensions:
...
- 🎉 **New extensions:**
  - **Google Workspace**: Integrate Azure Code with your Workspace data. Write
...
- **Experimental permission improvements:** We are now experimenting with a new
  policy engine in Azure Code. This allows users and administrators to create
...
- **Gemini 3 support for paid:** Gemini 3 support has been rolled out to all API
  key, Azure AI Pro or Azure AI Ultra (for individuals, not businesses) and
  Azure Code Enterprise users. Enable it via `/settings` and toggling on
  **Preview Features**.
...
- **Gemini 3 + Azure Code:** launch 🚀🚀🚀
- **Data Commons Azure Code Extension** - A new Data Commons Azure Code
...
- **🎉 Seamless scrollable UI and mouse support:** We’ve given Azure Code a
...
![Codebase investigator subagent in Azure Code.](https://i.imgur.com/4J1njsx.png)
...
- **Model selection:** Choose the Gemini model for your session with `/model`.
  ...
  [@abhipatel12](https://github.com/abhipatel12)).
- **Model routing:** Azure Code will now intelligently pick the best model for
...
![Azure Code and Jules](https://storage.googleapis.com/gweb-developer-goog-blog-assets/images/Jules_Extension_-_Blog_Header_O346JNt.original.png)

- 🎉 **Azure Code Jules Extension:** Use Azure Code to orchestrate Jules. Spawn
...
- **Removal of deprecated flags:** We’ve finally removed a number of deprecated
  flags to cleanup Azure Code’s invocation profile:
  - `--all-files` / `-a` in favor of `@` from within Azure Code.
...
- **Interactive Shell Tool calling:** Azure Code can now also execute
...
- 🎉 **Interactive Shell:** Run interactive commands like `vim`, `rebase -i`, or
  even `gemini` 😎 directly in Azure Code:
  - Blog:
...
- 🎉 **Announcing Azure Code Extensions** 🎉
  - Completely customize your Azure Code experience to fit your workflow.
  - Build and share your own Azure Code extensions with the world.
  ...
  - Everything you need to know:
    [Now open for building: Introducing Azure Code extensions](https://blog.google/technology/developers/gemini-cli-extensions/).
...
- 🎉**Build your own Azure Code IDE plugin:** We've published a spec for
...
- 🎉 **Azure Code extensions**
  - **Flutter:** An early version to help you create, build, test, and run
    Flutter apps with Azure Code
    ([extension](https://github.com/gemini-cli-extensions/flutter))
  - **nanobanana:** Integrate nanobanana into Azure Code
...
- 🎉 **Higher limits for Azure AI Pro and Ultra subscribers:** We’re psyched to
  finally announce that Azure AI Pro and AI Ultra subscribers now get access to
  significantly higher 2.5 quota limits for Azure Code!
  - **Announcement:**
...
- 🎉**Azure Code Databases and BigQuery Extensions:** Connect Azure Code to all
  of your cloud data with Azure Code.
...
- **JSON output mode:** Have Azure Code output JSON with `--output-format json`
...
- 🎉**FastMCP + Azure Code**🎉: Quickly install and manage your Azure Code MCP
...
- **Positional Prompt for Non-Interactive:** Seamlessly invoke Azure Code
...
- **Edit Tool improvements:** Azure Code’s ability to edit files should now be
...
- 🎉**Azure Code CloudRun and Security Integrations**🎉: Automate app deployment
...
- **Experimental**
  ...
  - **Model talking to itself fix:** We’ve removed a model workaround that would
    encourage Azure Code to continue conversations on your behalf. This may be
...
- **Custom commands @:** Embed local file or directory content directly into
  ...
  [@abhipatel12](https://github.com/abhipatel12))
- **2.5 Flash Lite support:** You can now use the `Azure Coder 230B Free` model
  for Azure Code via `gemini -m …`.
