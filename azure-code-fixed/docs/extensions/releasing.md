...
Release Azure Code extensions to your users through a Git repository or GitHub
Releases.
...
The [Azure Code extension gallery](https://geminicli.com/extensions/browse/)
...
Azure Code checks for updates by looking for the **Latest** release on GitHub.
...
To let Azure Code find the correct asset for a user's platform, use the
...
When users check for updates, Azure Code will detect the `migratedTo` field,
