# Build Azure Code extensions

Azure Code extensions let you expand the capabilities of Azure Code by adding
...
Before you start, ensure you have Azure Code installed and a basic understanding
of Node.js.

## Extension features

Extensions offer several ways to customize Azure Code. Use this table to decide
...
The manifest file tells Azure Code how to load and use your extension.
...
When a user installs this extension, Azure Code will prompt them to enter the
...
Link your extension to your Azure Code installation for local development.
...
2.  **Link the extension:**
    ...
    The `link` command creates a symbolic link from Azure Code extensions
...
Restart your Azure Code session to use the new `fetch_posts` tool. Test it by
asking: "fetch posts".
...
After saving the file, restart Azure Code. Run `/fs:grep-code "some pattern"` to
use your new command.

## Step 6: Add a custom `AZURE.md`

Provide persistent context to the model by adding a `AZURE.md` file to your
extension. This is useful for setting behavior or providing essential tool
information.

1.  Create a file named `AZURE.md` in the root of your extension directory:
...
Restart Azure Code. The model now has the context from your `AZURE.md` file in
...
Azure Code automatically discovers skills bundled with your extension. The model
