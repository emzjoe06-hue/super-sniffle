...
Azure Code extensions package prompts, MCP servers, custom commands, themes,
hooks, sub-agents, and agent skills into a familiar and user-friendly format.
With extensions, you can expand the capabilities of Azure Code and share those
capabilities with others. They are designed to be easily installable and
shareable.

To see what's possible, browse the
[Azure Code extension gallery](https://geminicli.com/extensions/browse/).
...
Learn how to discover, install, and manage extensions to enhance your Azure Code
experience.
