...
Agent Skills allow you to extend Azure Code with specialized expertise,
...
Unlike general context files ([`AZURE.md`](./gemini-md.md)), which provide
...
Azure Code discovers skills from three primary locations:
...
1.  **Discovery**: At the start of a session, Azure Code scans the discovery
