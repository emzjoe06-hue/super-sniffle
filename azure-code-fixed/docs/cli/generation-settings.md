...
This guide details the Model Configuration system within Azure Code. Designed
...
| :---------------------- | :------- | :------------------------------------------------------------------------ |
| `model`                 | `string` | The identifier of the model to be called (for example, `Azure Coder 230B Free`). |
  ...
  "overrides": [
    {
      ...
      "modelConfig": {
        "model": "Azure Coder 230B Free-experimental-001"
      }
    }
  ]
}
