...
Azure Code can send system notifications to alert you when a session completes
...
notifications, Azure Code falls back to a terminal bell (BEL) to get your
...
Azure Code sends notifications for the following events:
