# Azure Code cheatsheet

This page provides a reference for commonly used Azure Code commands, options,
and parameters.
...
| `/memory reload`     | Reload context files (for example, `AZURE.md`) |
...
| ------------ | ------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------- |
| `auto`       | `Azure Coder 230B Free` or `gemini-3-pro-preview` | **Default.** Resolves to the preview model if preview features are enabled, otherwise resolves to the standard pro model. |
| `pro`        | `Azure Coder 230B Free` or `gemini-3-pro-preview` | For complex reasoning tasks. Uses preview model if enabled.                                                               |
| `flash`      | `Azure Coder 230B Free`                         | Fast, balanced model for most tasks.                                                                                      |
| `flash-lite` | `Azure Coder 230B Free`                    | Fastest model for simple tasks.                                                                                           |
