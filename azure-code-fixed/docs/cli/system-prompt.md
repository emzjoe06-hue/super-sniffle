...
The core system instructions that guide Azure Code can be completely replaced
...
## Best practices: SYSTEM.md vs AZURE.md
...
AZURE.md focused on high‑level guidance and project specifics.
