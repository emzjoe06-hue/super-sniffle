...
Model steering lets you provide real-time guidance and feedback to Azure Code
...
When model steering is enabled, Azure Code treats any text you type while the
...
Azure Code acknowledges your hint with a brief message and injects it directly
...
When you submit a steering hint, Azure Code performs the following actions:
