...
which projects can use the full capabilities of Azure Code. It prevents
...
Once the feature is enabled, the first time you run Azure Code from a folder, a
...
Before you make a choice, Azure Code performs a **discovery phase** to scan the
...
When a folder is **untrusted**, Azure Code runs in a restricted "safe mode" to
...
Granting trust to a folder unlocks the full functionality of Azure Code for that
workspace.
