...
Azure Code also records the command and its output in the current session
...
You can automate tasks using a combination of Azure Code and shell commands.
...
Azure Code attempts to handle interactive commands (like `git add -p` or
...
Giving an AI access to your shell is powerful but risky. Azure Code includes
