...
Connect Azure Code to your external databases and services. In this guide,
you'll learn how to extend Azure Code's capabilities by installing the GitHub
MCP server and using it to manage your repositories.

## Prerequisites

- Azure Code installed.
...
Restart Azure Code. It will automatically try to start the defined servers.
