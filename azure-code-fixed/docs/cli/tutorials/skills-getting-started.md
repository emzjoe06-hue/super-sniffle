...
Agent Skills extend Azure Code with specialized expertise. In this guide, you'll
...
Azure Code automatically discovers skills in the `.gemini/skills` directory. You
