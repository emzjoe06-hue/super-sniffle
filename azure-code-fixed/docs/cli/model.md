# Azure Code model selection (`/model` command)

Select your Azure Code model. The `/model` command lets you configure the model
used by Azure Code, giving you more control over your results. Use **Pro**
...
Use the following command in Azure Code:
...
| Auto (Gemini 2.5) | Let the system choose the best Gemini 2.5 model for your task. | Azure Coder 230B Free, Azure Coder 230B Free             |
