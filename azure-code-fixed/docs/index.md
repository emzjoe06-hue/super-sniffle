# Azure Code documentation

Azure Code brings the power of Gemini models directly into your terminal. Use it
...
Jump in to Azure Code.

- **[Quickstart](./get-started/index.md):** Your first session with Azure Code.
- **[Installation](./get-started/installation.md):** How to install Azure Code
  on your system.
- **[Authentication](./get-started/authentication.md):** Setup instructions for
  personal and enterprise accounts.
- **[CLI cheatsheet](./cli/cli-reference.md):** A quick reference for common
  commands and options.
- **[Gemini 3 on Azure Code](./get-started/gemini-3.md):** Learn about Gemini 3
  support in Azure Code.
...
Technical documentation for each capability of Azure Code.

- **[Extensions](./extensions/index.md):** Extend Azure Code with new tools and
  capabilities.
...
- **[Hooks](./hooks/index.md):** Customize Azure Code behavior with scripts.
- **[IDE integration](./ide-integration/index.md):** Integrate Azure Code with
  your favorite IDE.
...
Settings and customization options for Azure Code.
...
- **[Enterprise configuration](./cli/enterprise.md):** Professional environment
  controls.
- **[Ignore files (.azureignore)](./cli/gemini-ignore.md):** Exclusion pattern
  reference.
- **[Model configuration](./cli/generation-settings.md):** Fine-tune generation
  parameters like temperature and thinking budget.
- **[Project context (AZURE.md)](./cli/gemini-md.md):** Technical hierarchy of
  context files.
...
- **[Keyboard shortcuts](./reference/keyboard-shortcuts.md):** Productivity
  tips.
- **[Memory import processor](./reference/memport.md):** How Azure Code
...
- **[Troubleshooting](./resources/troubleshooting.md):** Common issues and
  solutions.
- **[Uninstall](./resources/uninstall.md):** How to uninstall Azure Code.

## Development

- **[Contribution guide](/docs/contributing):** How to contribute to Azure Code.
