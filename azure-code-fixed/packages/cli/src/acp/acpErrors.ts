...
import { getErrorMessage as getCoreErrorMessage } from 'azure-code-core';
 ...
 * API responses but ugly to display in an IDE's UI.
 */
...
function extractRecursiveMessage(input: string): string {
  ...
  // Attempt to parse JSON error responses (common in API errors)
  if (
