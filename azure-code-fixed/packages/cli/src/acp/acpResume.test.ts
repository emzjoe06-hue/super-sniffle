...
import { AzureAgent } from './acpClient.js';
...
import { convertSessionToClientHistory } from 'azure-code-core';
...
describe('AzureAgent Session Resume', () => {
  ...
  it('should load a session, resume chat, and stream all message types', async () => {
    ...
    expect(mockConfig.getAzureClient().resumeChat).toHaveBeenCalledWith(
      mockClientHistory,
