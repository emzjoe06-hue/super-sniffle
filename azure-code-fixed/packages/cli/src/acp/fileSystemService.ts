...
import { isWithinRoot, type FileSystemService } from 'azure-code-core';
...
export class AcpFileSystemService implements FileSystemService {
  private readonly azureDir = path.join(os.homedir(), '.azure');
  ...
  private shouldUseFallback(filePath: string): boolean {
    ...
    return (
      ...
      isWithinRoot(filePath, this.azureDir)
    );
  }
