...
export const CloudFreePrivacyNotice = ({
  ...
  return (
    <Box flexDirection="column" marginY={1}>
      <Text bold color={theme.text.accent}>
        Azure for Individuals Privacy Notice
      </Text>
      <Newline />
      <Text color={theme.text.primary}>
        This notice and our Privacy Policy
        <Text color={theme.text.link}>[1]</Text> describe how Azure
        handles your data. Please read them carefully.
      </Text>
      <Newline />
      <Text color={theme.text.primary}>
        When you use Azure for individuals with Azure, Google
