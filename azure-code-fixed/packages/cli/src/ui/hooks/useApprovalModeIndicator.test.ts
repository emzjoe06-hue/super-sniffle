...
vi.mock('azure-code-core', async () => {
  const actualServerModule = await vi.importActual('azure-code-core');
  return {
    ...actualServerModule,
    Config: vi.fn(),
...
interface MockConfigInstanceShape {
  ...
  getAzureMdFileCount: Mock<() => number>;
  ...
  beforeEach(() => {
    ...
    (
      ...
      const instance: MockConfigInstanceShape = {
        ...
        getAzureMdFileCount: vi.fn().mockReturnValue(0) as Mock<() => number>,
        getToolRegistry: vi
          .fn()
