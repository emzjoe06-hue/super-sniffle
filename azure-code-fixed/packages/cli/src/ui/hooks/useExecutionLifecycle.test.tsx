...
import { NoopSandboxManager } from 'azure-code-core';
...
describe('useExecutionLifecycle', () => {
  ...
  let mockAzureClient: AzureClient;
  ...
  beforeEach(() => {
    ...
    mockAzureClient = { addHistory: vi.fn() } as unknown as AzureClient;
  ...
  it('should handle successful execution and update history correctly', async () => {
    ...
    expect(mockAzureClient.addHistory).toHaveBeenCalled();
  ...
  it('should handle command abort and display cancelled status', async () => {
    ...
    // to avoid duplication/flickering, as they are handled by useAzureStream.
