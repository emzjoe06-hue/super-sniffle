...
import { isNodeError, Storage } from 'azure-code-core';
...
export const commandDescriptions: Readonly<Record<Command, string>> = {
  ...
  [Command.FOCUS_SHELL_INPUT]: 'Move focus from Azure to the active shell.',
  [Command.UNFOCUS_SHELL_INPUT]: 'Move focus from the shell back to Azure.',
  ...
  [Command.UNFOCUS_BACKGROUND_SHELL]:
    'Move focus from background shell to Azure.',
  [Command.UNFOCUS_BACKGROUND_SHELL_LIST]:
    'Move focus from background shell list to Azure.',
  [Command.SHOW_BACKGROUND_SHELL_UNFOCUS_WARNING]:
