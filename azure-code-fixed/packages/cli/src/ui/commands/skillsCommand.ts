...
import { getAdminErrorMessage, getErrorMessage } from 'azure-code-core';
import {
  linkSkill,
...
export const skillsCommand: SlashCommand = {
  name: 'skills',
  description:
    'List, enable, disable, or reload Azure agent skills. Usage: /skills [list | disable <name> | enable <name> | reload]',
