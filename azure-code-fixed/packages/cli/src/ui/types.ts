...
export type HistoryItemAzure = HistoryItemBase & {
  type: 'azure';
  text: string;
};

export type HistoryItemAzureContent = HistoryItemBase & {
  type: 'gemini_content';
  text: string;
};
 ...
 * being submitted to the Azure model.
 */
...
/**
 * Defines the result of the slash command processor for its consumer (useAzureStream).
 */
