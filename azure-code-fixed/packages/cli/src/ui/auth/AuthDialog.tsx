...
export function AuthDialog({
  ...
  let items = [
    ...
    ...(process.env['CLOUD_SHELL'] === 'true'
      ...
      : process.env['AZURE_CODE_USE_COMPUTE_ADC'] === 'true'
        ...
        : []),
    {
      label: 'Use Azure API Key',
      value: AuthType.USE_AZURE,
      key: AuthType.USE_AZURE,
    },
    {
      label: 'Vertex AI',
  ...
  let initialAuthIndex = items.findIndex((item) => {
    ...
    if (process.env['AZURE_API_KEY']) {
      return item.value === AuthType.USE_AZURE;
    }
    ...
    async (authType: AuthType | undefined, scope: LoadableSettingScope) => {
      ...
      if (authType) {
        ...
        if (authType === AuthType.USE_AZURE) {
          ...
          // whether AZURE_API_KEY env var or a stored key exists.
  ...
  return (
    ...
    >
      ...
      <Box flexDirection="column" flexGrow={1}>
        ...
        <Box marginTop={1}>
          <Text color={theme.text.primary}>
            Terms of Services and Privacy Notice for Azure
          </Text>
        </Box>
        <Box marginTop={1}>
          <Text color={theme.text.link}>
            {'https://azurecode.com/docs/resources/tos-privacy/'}
          </Text>
        </Box>
      </Box>
    </Box>
