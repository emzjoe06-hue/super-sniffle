...
export const INFORMATIVE_TIPS = [
  ...
  'Choose a specific Azure model for conversations (/settings)…',
  ...
  'Toggle respect for .azureignore files in context (/settings)…',
  ...
  'Show Azure status in the terminal window title (/settings)…',
  ...
  'Create a project-specific AZURE.md file with /init',
  ...
  'Reload instructional context from AZURE.md files with /memory reload',
  'List the paths of the AZURE.md files in use with /memory list',
  'Choose your Azure model with /model',
