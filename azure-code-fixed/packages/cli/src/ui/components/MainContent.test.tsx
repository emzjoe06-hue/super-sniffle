...
import { makeFakeConfig, CoreToolCallStatus } from 'azure-code-core';
...
describe('MainContent', () => {
  ...
  it('renders multiple history items with single line padding between them', async () => {
    ...
    const uiState = {
      ...defaultMockUiState,
      history: [
        { id: 1, type: 'azure', text: 'Azure message 1\n'.repeat(10) },
        { id: 2, type: 'azure', text: 'Azure message 2\n'.repeat(10) },
      ],
  ...
  it('renders mixed history items (user + gemini) with single line padding between them', async () => {
    ...
    const uiState = {
      ...
      history: [
        ...
        { id: 2, type: 'azure', text: 'Azure response\n'.repeat(10) },
      ],
      constrainHeight: true,
      staticAreaMaxItemHeight: 5,
    };
