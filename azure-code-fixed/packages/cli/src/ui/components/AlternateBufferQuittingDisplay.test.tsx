...
import { CoreToolCallStatus } from 'azure-code-core';
...
vi.mock('../AzureRespondingSpinner.js', () => ({
  AzureRespondingSpinner: () => <Text>Spinner</Text>,
}));
...
describe('AlternateBufferQuittingDisplay', () => {
  ...
  it('renders with user and gemini messages', async () => {
    ...
    const history: HistoryItem[] = [
      { id: 1, type: 'user', text: 'Hello Azure' },
      { id: 2, type: 'azure', text: 'Hello User!' },
    ];
    const { lastFrame, unmount } = await renderWithProviders(
      <AlternateBufferQuittingDisplay />,
      {
