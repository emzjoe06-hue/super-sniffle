...
// Limit Azure messages to a very high number of lines to mitigate performance
// issues in the worst case if we somehow get an enormous response from Azure.
...
export const MainContent = () => {
      ...
      augmentedHistory.map(
        ({
          ...
          <MemoizedHistoryItemDisplay
            ...
            availableTerminalHeight={MAX_GEMINI_MESSAGE_LINES}
            key={item.id}
            item={item}
            isPending={false}
  ...
  // interactive. Azure messages and Tool results that are not scrollable,
