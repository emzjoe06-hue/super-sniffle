...
import { makeFakeConfig } from 'azure-code-core';
...
describe('<HistoryItemDisplay />', () => {
  ...
  it('renders AboutBox for "about" type', async () => {
    ...
    expect(lastFrame()).toContain('About Azure');
    unmount();
  });
  ...
  describe.each([true, false])(
    ...
    (useAlternateBuffer) => {
      ...
      it('should render a full gemini item when using availableTerminalHeight', async () => {
        const item: HistoryItem = {
          id: 1,
          type: 'azure',
          text: longCode,
      ...
      it('should render a full gemini_content item when using availableTerminalHeight', async () => {
        const item: HistoryItem = {
          id: 1,
          type: 'gemini_content',
          text: longCode,
