...
import { debugLogger, isGitRepository } from 'azure-code-core';
...
export function getInstallationInfo(
  ...
  try {
    ...
    if (
      ...
      const updateCommand = 'pnpm add -g azure-code@latest';
      return {
    ...
    if (realPath.includes('/.yarn/global')) {
      const updateCommand = 'yarn global add azure-code@latest';
      return {
    ...
    if (realPath.includes('/.bun/install/global')) {
      const updateCommand = 'bun add -g azure-code@latest';
      return {
    ...
    // Assume global npm
    const updateCommand = 'npm install -g azure-code@latest';
    return {
