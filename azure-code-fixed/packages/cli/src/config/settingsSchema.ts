  ...
  ui: {
    ...
    properties: {
      ...
      showStatusInTitle: {
        ...
        default: false,
        description:
          'Show Azure model thoughts in the terminal window title during the working phase',
        showInDialog: true,
      },
      dynamicWindowTitle: {
        type: 'boolean',
      ...
      showHomeDirectoryWarning: {
        ...
        default: true,
        description:
          'Show a warning when running Azure in the home directory.',
        showInDialog: true,
      },
      ...
      hideContextSummary: {
        ...
        default: false,
        description:
          'Hide the context summary (AZURE.md, MCP servers) above the input.',
        showInDialog: true,
      },
      footer: {
        type: 'object',
  ...
  model: {
    ...
    properties: {
      name: {
        ...
        requiresRestart: false,
        default: undefined as string | undefined,
        description: 'The Azure model to use for conversations.',
        showInDialog: true,
      },
      maxSessionTurns: {
        type: 'number',
  ...
  context: {
    ...
    properties: {
      ...
      memoryBoundaryMarkers: {
        ...
        description:
          'File or directory names that mark the boundary for AZURE.md discovery. ' +
      ...
      loadMemoryFromIncludeDirectories: {
        ...
        default: false,
        description: oneLine`
          Controls how /memory reload loads AZURE.md files.
      ...
      fileFiltering: {
        ...
        properties: {
          ...
          customIgnoreFilePaths: {
            ...
            default: [] as string[],
            description:
              'Additional ignore file paths to respect. These files take precedence over .azureignore and .gitignore. Files earlier in the array take precedence over files later in the array, e.g. the first file takes precedence over the second one.',
            showInDialog: true,
            items: { type: 'string' },
            mergeStrategy: MergeStrategy.UNION,
          },
  ...
  experimental: {
    ...
    properties: {
      ...
      extensionRegistryURI: {
        ...
        category: 'Experimental',
        requiresRestart: true,
        default: 'https://azurecode.com/extensions.json',
        description:
      ...
      gemmaModelRouter: {
        ...
        properties: {
          enabled: {
            ...
            default: false,
            description:
              'Enable the Gemma Model Router (experimental). Requires a local endpoint serving Gemma via the Azure API using LiteRT-LM shim.',
            showInDialog: false,
          },
          classifier: {
            type: 'object',
...
> = {
  MCPServerConfig: {
    ...
    properties: {
      ...
      extension: {
        type: 'object',
        description:
          'Metadata describing the Azure extension that owns this MCP server.',
  ...
  TelemetrySettings: {
    type: 'object',
    description: 'Telemetry configuration for Azure.',
    additionalProperties: false,
    properties: {
      enabled: {
        type: 'boolean',
  ...
  CustomTheme: {
    type: 'object',
    description:
      'Custom theme definition used for styling Azure output. Colors are provided as hex strings or named ANSI colors.',
    additionalProperties: false,
    properties: {
      type: {
        type: 'string',
        ...
        items: {
          ...
          properties: {
            condition: {
              type: 'object',
              properties: {
                useAzure3_1: { type: 'boolean' },
                useAzure3_1FlashLite: { type: 'boolean' },
