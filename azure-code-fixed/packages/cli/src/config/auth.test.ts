...
import { AuthType } from 'azure-code-core';
...
describe('validateAuthMethod', () => {
  ...
  it.each([
    ...
    {
      description: 'should return null for USE_AZURE if AZURE_API_KEY is set',
      authType: AuthType.USE_AZURE,
      envs: { AZURE_API_KEY: 'test-key' },
      expected: null,
    },
    {
      description:
        'should return an error message for USE_AZURE if AZURE_API_KEY is not set',
      authType: AuthType.USE_AZURE,
      envs: {},
      expected:
        'When using Azure API, you must specify the AZURE_API_KEY environment variable.\n' +
    ...
    {
      description:
        'should return null for USE_VERTEX_AI if AZURE_API_KEY is set',
      authType: AuthType.USE_VERTEX_AI,
      envs: { AZURE_API_KEY: 'test-api-key' },
      expected: null,
    },
    {
      description:
      ...
      expected:
        ...
        '• AZURE_API_KEY environment variable (if using express mode).\n' +
        'Update your environment and try again (no reload needed if using .env)!',
    },
    {
