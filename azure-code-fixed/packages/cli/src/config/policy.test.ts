...
import { writeToStderr } from 'azure-code-core';
...
describe('resolveWorkspacePolicyState', () => {
  ...
  beforeEach(() => {
    ...
    // Redirect AZURE_CODE_HOME to the temp directory to isolate integrity storage
    vi.stubEnv('AZURE_CODE_HOME', tempDir);
