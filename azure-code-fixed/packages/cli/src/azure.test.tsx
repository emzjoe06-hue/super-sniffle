...
describe('azure.tsx main function', () => {
...
describe('initializeOutputListenersAndFlush', () => {
  ...
  it('should flush backlogs and setup listeners if no listeners exist', async () => {
    const { coreEvents } = await import('azure-code-core');
...
describe('getNodeMemoryArgs', () => {
  ...
  beforeEach(() => {
    ...
    delete process.env['AZURE_CODE_NO_RELAUNCH'];
  ...
  it('should return empty array if AZURE_CODE_NO_RELAUNCH is set', () => {
    process.env['AZURE_CODE_NO_RELAUNCH'] = 'true';
...
describe('azure.tsx main function kitty protocol', () => {
  ...
  beforeEach(() => {
    ...
    originalEnvNoRelaunch = process.env['AZURE_CODE_NO_RELAUNCH'];
    process.env['AZURE_CODE_NO_RELAUNCH'] = 'true';
  ...
  afterEach(() => {
    ...
    if (originalEnvNoRelaunch !== undefined) {
      process.env['AZURE_CODE_NO_RELAUNCH'] = originalEnvNoRelaunch;
    } else {
      delete process.env['AZURE_CODE_NO_RELAUNCH'];
    }
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
...
describe('azure.tsx main function exit codes', () => {
  let originalEnvNoRelaunch: string | undefined;
  let originalIsTTY: boolean | undefined;
  ...
  it('should validate and refresh auth in non-interactive mode when no auth type is selected but env var is present', async () => {
    ...
    expect(refreshAuthSpy).toHaveBeenCalledWith(AuthType.USE_AZURE);
  });
});
...
describe('startInteractiveUI', () => {
  ...
  it('should enable mouse events when alternate buffer is enabled', async () => {
    const { enableMouseEvents } = await import('azure-code-core');
    await startTestInteractiveUI(
      mockConfig,
      mockSettings,
      mockStartupWarnings,
  ...
  it('should perform all startup tasks in correct order', async () => {
    const { getVersion } = await import('azure-code-core');
  ...
  it('should not recordSlowRender when less than threshold', async () => {
    const { recordSlowRender } = await import('azure-code-core');
