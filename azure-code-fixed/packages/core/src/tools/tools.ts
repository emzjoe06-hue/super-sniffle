...
import type { FunctionDeclaration, Part } from '../core/azureApiClient.js';
...
> {
  ...
  /**
   * Function declaration schema from Azure API.
...
export function toLlmContent(content: string | Part[]): Part[] {
