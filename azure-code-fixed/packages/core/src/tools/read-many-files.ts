...
export interface ReadManyFilesParams {
  ...
  /**
   * Whether to respect .gitignore and .azureignore patterns (optional, defaults to true)
   */
 ...
 * This combines the shared patterns with dynamic patterns like AZURE.md.
...
${finalExclusionPatternsForDescription
  ...
  async execute({ abortSignal: signal }: ExecuteOptions): Promise<ToolResult> {
      ...
      const { filteredPaths, ignoredCount } =
        fileDiscovery.filterFilesWithReport(relativeEntries, {
          ...
          respectAzureIgnore:
            ...
            this.config.getFileFilteringOptions().respectAzureIgnore ??
    ...
    // one, preventing shared parent AZURE.md files from being injected twice.
