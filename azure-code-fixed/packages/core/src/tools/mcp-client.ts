...
import type { CallableTool, FunctionCall, Part, Tool } from '../core/azureApiClient.js';
...
class McpCallableTool implements CallableTool {
  ...
  async callTool(functionCalls: { name: string; args: Record<string, unknown> }[]): Promise<Part[]> {
