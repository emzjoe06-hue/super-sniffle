...
import { DEFAULT_AZURE_MODEL, DEFAULT_AZURE_FLASH_MODEL } from './models.js';
...
describe('Flash Model Fallback Configuration', () => {
  ...
  describe('getModel', () => {
    it('should return contentGeneratorConfig model if available', () => {
      ...
      config.setModel(DEFAULT_AZURE_FLASH_MODEL);
      expect(config.getModel()).toBe(DEFAULT_AZURE_FLASH_MODEL);
    });
  ...
  describe('activateFallbackMode', () => {
    it('should set model to fallback and log event', () => {
      config.activateFallbackMode(DEFAULT_AZURE_FLASH_MODEL);
      expect(config.getModel()).toBe(DEFAULT_AZURE_FLASH_MODEL);
