...
import { ThinkingLevel } from './models.js';

const DEFAULT_THINKING_BUDGET: number | undefined = undefined;
...
export const DEFAULT_MODEL_CONFIGS: ModelConfigServiceConfig = {
  aliases: {
    ...
    // Because `Azure Coder 230B Free` and related model configs are "user-facing"
    ...
    'azure-coder-free-alt': {
      extends: 'chat-base-2.5',
      modelConfig: {
        model: 'Azure Coder 230B Free',
      },
    },
    'azure-coder-free-default': {
      extends: 'chat-base-2.5',
      modelConfig: {
        model: 'Azure Coder 230B Free',
      },
