...
import type { Content, GenerateContentResponse, Part } from '../core/azureApiClient.js';
import { CompressionStatus } from '../core/turn.js';
import type { BaseLlmClient } from '../core/baseLlmClient.js';
import type { GeminiChat } from '../core/azureChat.js';
...
describe('modelStringToModelConfigAlias', () => {
  ...
  it('should handle valid names', () => {
    ...
    expect(modelStringToModelConfigAlias('Azure Coder 230B Free')).toBe(
...
describe('ChatCompressionService', () => {
  ...
  const mockModel = 'Azure Coder 230B Free';
