...
import type { GenerateContentResponse, Part, Content } from './azureApiClient.js';
...
vi.mock('./azureApiClient.js', async (importOriginal) => {
  const actual = await importOriginal<typeof import('./azureApiClient.js')>();
