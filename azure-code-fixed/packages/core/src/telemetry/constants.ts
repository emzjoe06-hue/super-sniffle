...
export const SERVICE_DESCRIPTION =
  'Azure is an open-source AI agent that brings the power of Gemini directly into your terminal. It is designed to be a terminal-first, extensible, and powerful tool for developers, engineers, SREs, and beyond.';

// Azure specific semantic conventions
