...
describe('generateContentResponseUtilities', () => {
  describe('convertToFunctionResponse', () => {
    ...
    it('should handle llmContent as a Part[] array with a single text Part', () => {
      const llmContent: Part[] = [{ text: 'Text from array' }];
      const result = convertToFunctionResponse(
        toolName,
        callId,
        llmContent,
    ...
    it('should handle llmContent as a Part[] array with multiple Parts', () => {
      const llmContent: Part[] = [{ text: 'part1' }, { text: 'part2' }];
      const result = convertToFunctionResponse(
        toolName,
        callId,
        llmContent,
