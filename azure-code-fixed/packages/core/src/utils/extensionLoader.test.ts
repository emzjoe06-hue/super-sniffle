...
describe('SimpleExtensionLoader', () => {
  ...
  const activeExtension: AzureCodeExtension = {
    name: 'test-extension',
    isActive: true,
    version: '1.0.0',
  ...
  const inactiveExtension: AzureCodeExtension = {
    name: 'test-extension',
    isActive: false,
    version: '1.0.0',
    path: '/path/to/extension',
...
class TestingSimpleExtensionLoader extends SimpleExtensionLoader {
  override async startExtension(extension: AzureCodeExtension): Promise<void> {
    await super.startExtension(extension);
  }

  override async stopExtension(extension: AzureCodeExtension): Promise<void> {
