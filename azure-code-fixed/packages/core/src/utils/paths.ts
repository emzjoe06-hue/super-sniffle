...
export const AZURE_CLI_HOME_ENV = 'AZURE_CODE_HOME';

// Stub for Google accounts file — not used in Azure fork
export const GOOGLE_ACCOUNTS_FILENAME = 'google_accounts.json';

/**
 * Returns the home directory.
 * If AZURE_CODE_HOME environment variable is set, it returns its value.
 * Otherwise, it returns the user's home directory.
 */
export function homedir(): string {
  const envHome = process.env['AZURE_CODE_HOME'];
  if (envHome) {
    return envHome;
  }
  return os.homedir();
