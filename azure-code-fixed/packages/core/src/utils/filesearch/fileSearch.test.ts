...
import { createTmpDir, cleanupTmpDir } from 'azure-code-test-utils';
...
describe('FileSearch', () => {
  ...
  it('should use .azureignore rules', async () => {
    tmpDir = await createTmpDir({
      [AZURE_IGNORE_FILE_NAME]: 'dist/',
      dist: ['ignored.js'],
      src: ['not-ignored.js'],
    });
  ...
  it('should combine .gitignore and .azureignore rules', async () => {
    tmpDir = await createTmpDir({
      '.git': {},
      '.gitignore': 'dist/',
      [AZURE_IGNORE_FILE_NAME]: 'build/',
