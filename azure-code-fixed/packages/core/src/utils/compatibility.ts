...
export function getCompatibilityWarnings(options?: {
  ...
  if (isGnuScreen()) {
    warnings.push({
      id: 'gnu-screen',
      message:
        'Warning: GNU screen detected. Some keyboard shortcuts and visual features may behave unexpectedly. For the best experience, consider using tmux or running Azure directly in your terminal.',
