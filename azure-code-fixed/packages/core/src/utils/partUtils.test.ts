...
import type { GenerateContentResponse, Part, Part } from '../core/azureApiClient.js';
...
describe('partUtils', () => {
  ...
  describe('flatMapTextParts', () => {
    ...
    const splitCharsTransform = async (text: string): Promise<Part[]> =>
    ...
    it('should transform an array of text parts and flatten the result', async () => {
      ...
      const duplicateTransform = async (text: string): Promise<Part[]> => [
        { text: `${text}` },
        { text: `${text}` },
      ];
    ...
    it('should handle a mix of text and non-text parts in an array', async () => {
      ...
      const parts: Part[] = [{ text: 'go' }, nonTextPart, ' stop'];
    ...
    it('should handle a transform that returns an empty array', async () => {
      const removeTransform = async (_text: string): Promise<Part[]> => [];
      const parts: Part[] = [
        { text: 'remove' },
