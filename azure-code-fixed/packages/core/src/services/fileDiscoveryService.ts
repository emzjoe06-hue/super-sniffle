...
export class FileDiscoveryService {
  ...
  constructor(projectRoot: string, options?: FilterFilesOptions) {
    ...
    if (this.gitIgnoreFilter) {
      ...
      const customPatterns = this.customIgnoreFilter
        ...
        : [];
      // Create combined parser: .gitignore + .azureignore + custom ignore
  ...
  private applyFilterFilesOptions(options?: FilterFilesOptions): void {
    ...
    if (options.respectAzureIgnore !== undefined) {
      this.defaultFilterFileOptions.respectAzureIgnore =
        options.respectAzureIgnore;
    }
  ...
  private _shouldIgnore(
    ...
    const {
      ...
      respectAzureIgnore = this.defaultFilterFileOptions.respectAzureIgnore,
    } = options;

    if (respectGitIgnore && respectAzureIgnore && this.combinedIgnoreFilter) {
  ...
  /**
   * Returns the list of ignore files being used (e.g. .azureignore) excluding .gitignore.
   */
