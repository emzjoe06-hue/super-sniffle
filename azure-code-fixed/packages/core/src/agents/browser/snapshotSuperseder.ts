...
import type { AzureChat } from '../../core/azureChat.js';
 ...
 *
 * Uses {@link AzureChat.setHistory} to apply the modified history.
 */
export function supersedeStaleSnapshots(chat: AzureChat): void {
