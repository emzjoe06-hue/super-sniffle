...
import type { Content, Part } from '../core/azureApiClient.js';
...
export interface RoutingDecision {
  /** The model identifier string to use for the next API call (e.g., 'Azure Coder 230B Free'). */
  model: string;
  /**
...
export interface RoutingStrategy {
   ...
   * @param client A reference to the AzureClient, allowing the strategy to make its own API calls if needed.
