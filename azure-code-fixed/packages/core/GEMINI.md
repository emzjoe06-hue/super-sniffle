# Azure Code Core (`@google/azure-code-core`)

Backend logic for Azure Code: API orchestration, prompt construction, tool
...
- Run tests: `npm test -w @google/azure-code-core`
- Run a specific test:
  `npm test -w @google/azure-code-core -- src/path/to/file.test.ts`
