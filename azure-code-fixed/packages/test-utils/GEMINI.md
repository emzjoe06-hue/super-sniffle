# Azure Code Test Utils (`@google/azure-code-test-utils`)
...
1. **Programmatic Builder:**
   ...
   ```typescript
   import { TestMcpServerBuilder } from '@google/azure-code-test-utils';
...
Import from `@google/azure-code-test-utils` in test files across the monorepo.
