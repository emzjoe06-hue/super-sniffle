# Azure Code A2A Server (`azure-code-a2a-server`)

Experimental Agent-to-Agent (A2A) server that exposes Azure Code capabilities
...
- Run tests: `npm test -w azure-code-a2a-server`
