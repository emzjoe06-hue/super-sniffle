# RFC: Azure Code A2A Development-Tool Extension

## 1. Introduction

### 1.1 Overview

To standardize client integrations with the Azure Code agent, this document
...
required for rich, interactive workflows with the Azure Code agent.

### 1.2 Motivation

Recent work integrating Azure Code with clients like Zed and Gemini Code
...
- **Ecosystem Alignment**: Aligns Azure Code with a growing industry standard,
...
workflows between a client and the Azure Code agent. It consists of a
...
// Configuration settings for the Azure Code agent.
